...
.field final t:Landroid/support/v4/app/m;

.field u:Landroid/support/v4/app/b;

.field v:Landroid/support/v4/app/b;
...
.method public constructor <init>(Landroid/support/v4/app/m;)V
    ...
    .line 334
    iput-object p1, p0, Landroid/support/v4/app/a;->t:Landroid/support/v4/app/m;
...
.method private a(Z)I
    ...
    .line 591
    iget-object v0, p0, Landroid/support/v4/app/a;->t:Landroid/support/v4/app/m;
...
.method private b(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)V
    ...
    iput-object v0, p2, Landroid/support/v4/app/Fragment;->ar:Landroid/support/v4/app/m;
    ...
    iput v1, v0, Landroid/support/v4/app/b;->S:I

    .line 416
    iput-object p2, v0, Landroid/support/v4/app/b;->T:Landroid/support/v4/app/Fragment;
...
# virtual methods
.method public final a(ILandroid/support/v4/app/Fragment;)Landroid/support/v4/app/v;
    .locals 1
    .parameter
    .parameter
    ...
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v4/app/a;->b(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)V

    .line 385
    return-object p0
.end method

.method public final a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/v;
    .locals 0
    .parameter
    .parameter
    .parameter
...
.method public final a(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/v;
    .locals 2
    .parameter
    ...
    .line 436
    iput-object p1, v0, Landroid/support/v4/app/b;->T:Landroid/support/v4/app/Fragment;
...
.method final a(I)V
    ...
    .line 554
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/a;->u:Landroid/support/v4/app/b;
    ...
    .line 556
    iget-object v0, v2, Landroid/support/v4/app/b;->T:Landroid/support/v4/app/Fragment;
    ...
    iget-object v1, v2, Landroid/support/v4/app/b;->T:Landroid/support/v4/app/Fragment;
    ...
    .line 561
    :cond_3
    iget-object v0, v2, Landroid/support/v4/app/b;->Y:Ljava/util/ArrayList;
    ...
    .line 569
    :cond_5
    iget-object v0, v2, Landroid/support/v4/app/b;->P:Landroid/support/v4/app/b;
...
.method final a(Landroid/support/v4/app/b;)V
    ...
    .line 365
    iput-object p1, p0, Landroid/support/v4/app/a;->v:Landroid/support/v4/app/b;

    iput-object p1, p0, Landroid/support/v4/app/a;->u:Landroid/support/v4/app/b;

    .line 371
    :goto_0
    iget v0, p0, Landroid/support/v4/app/a;->B:I

    iput v0, p1, Landroid/support/v4/app/b;->U:I

    .line 372
    iget v0, p0, Landroid/support/v4/app/a;->C:I

    iput v0, p1, Landroid/support/v4/app/b;->V:I

    .line 373
    iget v0, p0, Landroid/support/v4/app/a;->D:I

    iput v0, p1, Landroid/support/v4/app/b;->W:I

    .line 374
    iget v0, p0, Landroid/support/v4/app/a;->E:I

    iput v0, p1, Landroid/support/v4/app/b;->X:I
    ...
    iput v0, p0, Landroid/support/v4/app/a;->A:I
    ...
    .line 367
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/a;->v:Landroid/support/v4/app/b;

    iput-object v0, p1, Landroid/support/v4/app/b;->Q:Landroid/support/v4/app/b;

    .line 368
    iget-object v0, p0, Landroid/support/v4/app/a;->v:Landroid/support/v4/app/b;

    iput-object p1, v0, Landroid/support/v4/app/b;->P:Landroid/support/v4/app/b;
...
.method public final a(Ljava/lang/String;Ljava/io/PrintWriter;Z)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/a;->mName:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/support/v4/app/a;->M:Ljava/lang/CharSequence;
    ...
    .line 284
    iget v0, v3, Landroid/support/v4/app/b;->S:I
    ...
    iget v5, v3, Landroid/support/v4/app/b;->S:I
    ...
    iget-object v0, v3, Landroid/support/v4/app/b;->T:Landroid/support/v4/app/Fragment;
    ...
    .line 299
    iget v0, v3, Landroid/support/v4/app/b;->U:I

    if-nez v0, :cond_9

    iget v0, v3, Landroid/support/v4/app/b;->V:I
    ...
    .line 305
    :cond_a
    iget v0, v3, Landroid/support/v4/app/b;->W:I

    if-nez v0, :cond_b

    iget v0, v3, Landroid/support/v4/app/b;->X:I
    ...
    .line 312
    :cond_c
    iget-object v0, v3, Landroid/support/v4/app/b;->Y:Ljava/util/ArrayList;
    ...
    .line 313
    :goto_2
    iget-object v5, v3, Landroid/support/v4/app/b;->Y:Ljava/util/ArrayList;
    ...
    .line 327
    :cond_f
    iget-object v3, v3, Landroid/support/v4/app/b;->P:Landroid/support/v4/app/b;
...
.method public final b()Landroid/support/v4/app/v;
    .locals 2
...
.method public final b(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/v;
    .locals 2
    .parameter
...
.method public final c(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/v;
    .locals 2
    .parameter
...
.method public final c()V
    ...
    iget v2, v3, Landroid/support/v4/app/b;->S:I
    ...
    .line 705
    iget v1, v3, Landroid/support/v4/app/b;->X:I

    iput v1, v0, Landroid/support/v4/app/Fragment;->aF:I

    .line 706
    iget-object v1, p0, Landroid/support/v4/app/a;->t:Landroid/support/v4/app/m;

    iget v4, p0, Landroid/support/v4/app/a;->F:I
    ...
    :cond_1
    :goto_1
    iget-object v0, v3, Landroid/support/v4/app/b;->Q:Landroid/support/v4/app/b;
    ...
    .line 721
    iget v4, v3, Landroid/support/v4/app/b;->W:I

    iput v4, v0, Landroid/support/v4/app/Fragment;->aF:I

    .line 722
    iget-object v4, p0, Landroid/support/v4/app/a;->t:Landroid/support/v4/app/m;
    ...
    .line 728
    iget v1, v3, Landroid/support/v4/app/b;->W:I
    ...
    iget v1, v1, Landroid/support/v4/app/m;->bq:I

    iget v2, p0, Landroid/support/v4/app/a;->F:I

    invoke-static {v2}, Landroid/support/v4/app/m;->e(I)I
    ...
    iget v1, p0, Landroid/support/v4/app/a;->K:I

    invoke-virtual {v0, v1}, Landroid/support/v4/app/m;->d(I)V

    .line 770
    iput v6, p0, Landroid/support/v4/app/a;->K:I
...
.method public final run()V
    ...
    .line 612
    iget v0, v4, Landroid/support/v4/app/b;->S:I
    ...
    iget v2, v4, Landroid/support/v4/app/b;->S:I
    ...
    .line 614
    :pswitch_0
    iget-object v0, v4, Landroid/support/v4/app/b;->T:Landroid/support/v4/app/Fragment;

    .line 615
    iget v1, v4, Landroid/support/v4/app/b;->U:I
    ...
    :cond_2
    :goto_1
    iget-object v0, v4, Landroid/support/v4/app/b;->P:Landroid/support/v4/app/b;
    ...
    iget-object v1, v1, Landroid/support/v4/app/m;->bj:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Landroid/support/v4/app/m;->bj:Ljava/util/ArrayList;
    ...
    .line 623
    sget-boolean v5, Landroid/support/v4/app/m;->DEBUG:Z
    ...
    iput-object v3, v4, Landroid/support/v4/app/b;->T:Landroid/support/v4/app/Fragment;
    ...
    .line 629
    :cond_6
    iget-object v5, v4, Landroid/support/v4/app/b;->Y:Ljava/util/ArrayList;
    ...
    iput-object v5, v4, Landroid/support/v4/app/b;->Y:Ljava/util/ArrayList;
    ...
    .line 633
    iget v5, v4, Landroid/support/v4/app/b;->V:I

    iput v5, v0, Landroid/support/v4/app/Fragment;->aF:I

    .line 634
    iget-boolean v5, p0, Landroid/support/v4/app/a;->H:Z
    ...
    .line 639
    :cond_8
    iget-object v5, p0, Landroid/support/v4/app/a;->t:Landroid/support/v4/app/m;

    iget v6, p0, Landroid/support/v4/app/a;->F:I

    iget v7, p0, Landroid/support/v4/app/a;->G:I
    ...
    .line 645
    iget v0, v4, Landroid/support/v4/app/b;->U:I

    iput v0, v3, Landroid/support/v4/app/Fragment;->aF:I
    ...
    .line 651
    iget v1, v4, Landroid/support/v4/app/b;->V:I
...
.method public final toString()Ljava/lang/String;
    ...
    .line 228
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/a;->mName:Ljava/lang/String;
