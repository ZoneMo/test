...
{
  private static final char[] bKd = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".toCharArray();
  ...
  private static char[] b(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    for (int m = (k - 1) / 76 << 1; ; m = 0)
    {
      ...
      while (i3 < j)
      {
        ...
        int i15 = i2 + 1;
        arrayOfChar[i2] = bKd[(0x3F & i14 >>> 18)];
        int i16 = i15 + 1;
        arrayOfChar[i15] = bKd[(0x3F & i14 >>> 12)];
        int i17 = i16 + 1;
        arrayOfChar[i16] = bKd[(0x3F & i14 >>> 6)];
        i2 = i17 + 1;
        arrayOfChar[i17] = bKd[(i14 & 0x3F)];
        if (paramBoolean)
        {
          i1++;
          if ((i1 == 19) && (i2 < n - 2))
    ...
    if (i4 > 0)
    {
      ...
      i7 = i6 | i5;
      arrayOfChar[(n - 4)] = bKd[(i7 >> 12)];
      arrayOfChar[(n - 3)] = bKd[(0x3F & i7 >>> 6)];
      i8 = n - 2;
      if (i4 != 2)
        break label422;
    }
    label422: for (int i9 = bKd[(i7 & 0x3F)]; ; i9 = 61)
    {
      arrayOfChar[i8] = i9;
      arrayOfChar[(n - 1)] = '=';
      return arrayOfChar;
  ...
  public static final String c(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    return new String(b(paramArrayOfByte, paramBoolean));
  }
