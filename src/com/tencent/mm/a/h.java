...
public final class h
{
  public static char a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, long paramLong, int paramInt1, byte[] paramArrayOfByte3, int paramInt2)
  {
    ...
    localg6.bKh = 0;
    localg6.bKg = localg5.bKg;
    localg7.bKh = 28;
    localg7.bKg = localg5.bKg;
    localg8.bKh = 0;
    localg8.bKg = localg10.bKg;
    localg9.bKh = 32;
    localg9.bKg = localg10.bKg;
    a(localg4, 24);
  ...
  private static void a(g paramg1, g paramg2, int paramInt)
  {
    for (int i = 0; i < paramInt; i++)
    {
      byte[] arrayOfByte = paramg1.bKg;
      int j = i + paramg1.bKh;
      arrayOfByte[j] = ((byte)(arrayOfByte[j] ^ paramg2.bKg[(i + paramg2.bKh)]));
    }
  }
  ...
  {
    for (int i = 0; i < 8; i++)
      paramg1.bKg[(i + paramg1.bKh)] = ((byte)(paramg2.bKg[(i + paramg2.bKh)] ^ paramg3.bKg[(i + paramg3.bKh)]));
  }
  ...
  private static void a(g paramg1, g paramg2, g paramg3, g paramg4)
  {
    ...
    while (i < 8)
    {
      int m = (byte)((paramg3.bKg[(0 + paramg3.bKh)] << 1) + paramg3.bKg[(5 + paramg3.bKh)]);
      int n = (byte)((paramg3.bKg[(1 + paramg3.bKh)] << 3) + (paramg3.bKg[(2 + paramg3.bKh)] << 2) + (paramg3.bKg[(3 + paramg3.bKh)] << 1) + paramg3.bKg[(4 + paramg3.bKh)]);
      b(paramg1, new g(arrayOfByte[i][m][n]), 4);
      i = (byte)(i + 1);
      paramg3.bKh = (6 + paramg3.bKh);
      paramg1.bKh = (4 + paramg1.bKh);
    }
    paramg3.bKh = j;
    paramg1.bKh = k;
  ...
  {
    for (int i = 0; i < paramInt; i++)
      paramg3.bKg[(i + paramg3.bKh)] = paramg2.bKg[(-1 + (paramg2.bKh + paramArrayOfByte[i]))];
  ...
  private static void a(g paramg1, g paramg2, g[] paramArrayOfg, int paramInt, g paramg3, g paramg4, g paramg5, g paramg6, g paramg7, g paramg8)
  {
    ...
    for (int j = 0; j < 64; j++)
    {
      byte[] arrayOfByte3 = paramg1.bKg;
      int k = paramg1.bKh + (j >> 3);
      arrayOfByte3[k] = ((byte)(arrayOfByte3[k] | paramg3.bKg[(j + paramg3.bKh)] << (j & 0x7)));
    }
  }
  ...
  {
    for (int i = 0; i < paramInt; i++)
      paramg1.bKg[(i + paramg1.bKh)] = ((byte)(0x1 & paramg2.bKg[((i >> 3) + paramg2.bKh)] >> (i & 0x7)));
  }
  ...
  private static void c(g paramg1, g paramg2, int paramInt)
  {
    ...
    for (int i = 0; ; i++)
    {
      ...
      if (i >= j)
        break;
      paramg1.bKg[(i + paramg1.bKh)] = paramg1.bKg[(paramInt + (i + paramg1.bKh))];
    }
    while (k < paramInt)
    {
      paramg1.bKg[(28 + (k + paramg1.bKh) - paramInt)] = paramg2.bKg[(k + paramg2.bKh)];
      k++;
    }
  }
  ...
  {
    for (int i = 0; i < paramInt; i++)
      paramg1.bKg[(i + paramg1.bKh)] = paramg2.bKg[(i + paramg2.bKh)];
  }
}
