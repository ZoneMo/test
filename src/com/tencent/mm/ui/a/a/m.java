...
public final class m
{
  ...
  public static String c(String paramString1, String paramString2, Bundle paramBundle)
  {
    if (paramString2.equals("GET"))
      paramString1 = paramString1 + "?" + x(paramBundle);
    aa.d("Facebook-Util", paramString2 + " URL: " + paramString1);
    ...
    try
    {
      String str1 = e(localHttpURLConnection.getInputStream());
      return str1;
    }
    catch (FileNotFoundException localFileNotFoundException)
    {
    }
    return e(localHttpURLConnection.getErrorStream());
  }
  ...
  public static Bundle xj(String paramString)
  {
    Bundle localBundle = new Bundle();
    if (paramString != null)
    {
  ...
  public static Bundle xk(String paramString)
  {
 ...
 * Qualified Name:     com.tencent.mm.ui.a.a.m
