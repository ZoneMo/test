  ...
  implements e
{
  ...
  private void g(int paramInt)
  {
    ...
    //   6: iflt +20 -> 26
    //   9: aload_0
    //   10: getfield 37	com/tencent/mm/ui/tools/a/t:cJ	Ljava/util/LinkedHashMap;
    ...
    //   69: if_icmple +13 -> 82
    //   72: aload_0
    //   73: getfield 37	com/tencent/mm/ui/tools/a/t:cJ	Ljava/util/LinkedHashMap;
    ...
    //   84: return
    //   85: aload_0
    //   86: getfield 37	com/tencent/mm/ui/tools/a/t:cJ	Ljava/util/LinkedHashMap;
    ...
    //   126: astore 5
    //   128: aload_0
    //   129: getfield 37	com/tencent/mm/ui/tools/a/t:cJ	Ljava/util/LinkedHashMap;
    //   132: aload 4
    ...
    //   143: aload 5
    //   145: invokestatic 132	com/tencent/mm/ui/tools/a/ah:s	(Landroid/graphics/Bitmap;)I
    //   148: isub
    //   149: putfield 65	com/tencent/mm/ui/tools/a/t:size	I
    //   152: aload_0
    //   153: iconst_1
    //   154: aload_0
    //   155: getfield 134	com/tencent/mm/ui/tools/a/t:cM	I
    //   158: iadd
    //   159: putfield 134	com/tencent/mm/ui/tools/a/t:cM	I
    //   162: aload_0
    //   163: monitorexit
    //   164: goto -164 -> 0
    //
  ...
  public final Bitmap fP(String paramString)
  {
    if (paramString == null)
      throw new NullPointerException("key == null");
    try
    {
      Bitmap localBitmap = (Bitmap)this.cJ.get(paramString);
      if (localBitmap != null)
      {
        this.cN = (1 + this.cN);
        return localBitmap;
  ...
  public final void s(String paramString, Bitmap paramBitmap)
  {
    ...
    {
      this.cL = (1 + this.cL);
      this.size += ah.s(paramBitmap);
      Bitmap localBitmap = (Bitmap)this.cJ.put(paramString, paramBitmap);
      if (localBitmap != null)
        this.size -= ah.s(localBitmap);
      g(this.cK);
      return;
    }
    finally
