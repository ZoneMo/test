...
{
  private static final String[] hqg = { "orientation" };

  i(Context paramContext, n paramn, e parame, af paramaf, a parama)
  {
  ...
  private static int a(android.content.ContentResolver paramContentResolver, android.net.Uri paramUri)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: getstatic 14	com/tencent/mm/ui/tools/a/i:hqg	[Ljava/lang/String;
    //   5: aconst_null
    //   6: aconst_null
    //   7: aconst_null
  ...
  {
    this.hqe = a(this.context.getContentResolver(), paramab.uri);
