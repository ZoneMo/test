...
{
  private static HashMap gGL = new HashMap();
  private static final Class[] gGN = { Context.class, AttributeSet.class };
  private final Object[] gGM = new Object[2];
  ...
  {
    // Byte code:
    //   0: getstatic 21	com/tencent/mm/ui/base/preference/ae:gGL	Ljava/util/HashMap;
    //   3: aload_1
    ...
    //   17: aload_0
    //   18: getfield 35	com/tencent/mm/ui/base/preference/ae:mContext	Landroid/content/Context;
    ...
    //   57: getstatic 29	com/tencent/mm/ui/base/preference/ae:gGN	[Ljava/lang/Class;
    //   60: invokevirtual 99	java/lang/Class:getConstructor	([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    //   63: astore 20
    //   65: aload 20
    //   67: astore 5
    //   69: getstatic 21	com/tencent/mm/ui/base/preference/ae:gGL	Ljava/util/HashMap;
    //   72: aload_1
    //   73: aload 5
    //   75: invokevirtual 103	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   78: pop
    //   79: aload_0
    //   80: getfield 33	com/tencent/mm/ui/base/preference/ae:gGM	[Ljava/lang/Object;
    //   83: astore 16
    //   85: aload 16
    //   87: iconst_1
    //   88: aload_3
  ...
  private void a(XmlPullParser paramXmlPullParser, n paramn, AttributeSet paramAttributeSet)
  {
    ...
    while (((j != 3) || (paramXmlPullParser.getDepth() > i)) && (j != 1))
      ...
      {
        paramn.a(a(paramXmlPullParser.getName(), paramAttributeSet), -1);
        j = paramXmlPullParser.next();
      }
  }
  ...
  public final void a(int paramInt, n paramn)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 35	com/tencent/mm/ui/base/preference/ae:mContext	Landroid/content/Context;
    ...
    //   11: astore_3
    //   12: aload_0
    //   13: getfield 33	com/tencent/mm/ui/base/preference/ae:gGM	[Ljava/lang/Object;
    //   16: astore 5
    //   18: aload 5
    //   20: monitorenter
    //   21: aload_3
    ...
    //   25: astore 7
    //   27: aload_0
    //   28: getfield 33	com/tencent/mm/ui/base/preference/ae:gGM	[Ljava/lang/Object;
    //   31: iconst_0
    //   32: aload_0
    //   33: getfield 35	com/tencent/mm/ui/base/preference/ae:mContext	Landroid/content/Context;
    //   36: aastore
    //   37: aload_3
    ...
    //   137: aload 7
    //   139: invokespecial 137	com/tencent/mm/ui/base/preference/ae:a	(Ljava/lang/String;Landroid/util/AttributeSet;)Lcom/tencent/mm/ui/base/preference/Preference;
    //   142: pop
    //   143: aload_0
    //   144: aload_3
    //   145: aload_2
    //   146: aload 7
    //   148: invokespecial 173	com/tencent/mm/ui/base/preference/ae:a	(Lorg/xmlpull/v1/XmlPullParser;Lcom/tencent/mm/ui/base/preference/n;Landroid/util/AttributeSet;)V
    //   151: aload 5
    //   153: monitorexit
    //   154: aload_3
