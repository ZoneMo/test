...
public final class ba
{
  ...
  // ERROR //
  private static Intent U(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aload_0
    ...
    //   51: invokestatic 56	com/tencent/mm/sdk/platformtools/aa:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   54: iconst_0
    //   55: istore 5
    //   57: aload 4
    ...
    //   105: invokestatic 56	com/tencent/mm/sdk/platformtools/aa:e	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   189: invokestatic 56	com/tencent/mm/sdk/platformtools/aa:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   192: iconst_0
    //   193: istore 14
    //   195: iload 14
    //   197: iload 12
  ...
  public static int aK(Context paramContext)
  {
    ...
    aa.e("MicroMsg.NetStatusUtil", "activeNetInfo extra=%s, type=%d", arrayOfObject);
  ...
  public static String bn(Context paramContext)
  {
    ...
    aa.e("MicroMsg.NetStatusUtil", "getISPName ISPName=%s", arrayOfObject);
  ...
  {
    return aK(paramContext) == 0;
  }

  public static WifiInfo bu(Context paramContext)
  {
    try
    {
      ConnectivityManager localConnectivityManager = (ConnectivityManager)paramContext.getSystemService("connectivity");
  ...
  public static int by(Context paramContext)
  {
    ...
    try
    {
      ...
      ((TelephonyManager)paramContext.getSystemService("phone")).listen(new bb(), 256);
      int i = Math.abs(gee);
      return i;
    }
    catch (Exception localException)
  ...
  public static void p(Context paramContext, int paramInt)
  {
    ...
    case 2:
      ...
      catch (Exception localException3)
      {
        ...
        {
          U(paramContext, "ManageAccountsSettings");
          return;
        }
      }
    case 1:
      ...
      {
        U(paramContext, "DevelopmentSettings");
        return;
      }
    case 3:
    }
    ...
    {
      U(paramContext, "AdvancedSettings");
    }
  }
}
