...
public final class cy extends com.tencent.mm.am.a
{
  public int fAC;
  public LinkedList fAD = new LinkedList();

  public static boolean a(a.a.a.a.a parama, cy paramcy, int paramInt)
  {
    switch (paramInt)
    {
    default:
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      for (boolean bool = true; bool; bool = cx.a(locala, localcx, a(locala)));
      paramcy.fAD.add(localcx);
    }
    return true;
  }
