...
{
  private static final String[] cs = { "_display_name", "_size" };
  private static final File cu = new File("/");
  private static HashMap cv = new HashMap();
  private a cw;
  ...
  private static a b(Context paramContext, String paramString)
  {
    ...
    synchronized (cv)
    {
      localObject2 = (a)cv.get(paramString);
    ...
    while (true)
    {
      ...
      catch (IOException localIOException)
      {
        ...
        {
          localObject3 = a(cu, new String[] { str3 });
      ...
      else if ("external-path".equals(str1))
      {
        ...
        continue;
        label297: cv.put(paramString, localObject2);
        return localObject2;
      }
      else
      {
  ...
  public void attachInfo(Context paramContext, ProviderInfo paramProviderInfo)
  {
    ...
    this.cw = b(paramContext, paramProviderInfo.authority);
  }

  public int delete(Uri paramUri, String paramString, String[] paramArrayOfString)
  {
    if (this.cw.a(paramUri).delete())
      return 1;
    return 0;
  }
  ...
  {
    File localFile = this.cw.a(paramUri);
