...
final class a
{
  ...
  private byte[] cJ(byte[] paramArrayOfByte)
  {
    int i = 16;
    try
    {
      long l1 = t(paramArrayOfByte, 0);
      long l2 = t(paramArrayOfByte, 4);
      long l3 = t(this.key, 0);
      long l4 = t(this.key, 4);
      long l5 = t(this.key, 8);
      long l6 = t(this.key, 12);
      long l7 = 3816266640L;
      while (true)
      {
        int j = i - 1;
  ...
  private static long t(byte[] paramArrayOfByte, int paramInt)
  {
    long l = 0L;
    int i = paramInt + 4;
    while (true)
  ...
  private boolean u(byte[] paramArrayOfByte, int paramInt)
  {
    boolean bool = true;
    for (this.pos = 0; ; this.pos = (1 + this.pos))
    {
      if (this.pos >= 8)
      {
        this.prePlain = cJ(this.prePlain);
  ...
  protected final byte[] decrypt(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    if ((i % 8 != 0) || (i < 16))
      return null;
    this.prePlain = cJ(paramArrayOfByte1);
      ...
      while (true)
      {
        ...
        while (true)
        {
          if (this.padding >= 8)
          {
            ...
            if (this.pos != 8)
              break label134;
            if (u(paramArrayOfByte1, i))
              break label428;
            return null;
            if (this.pos < 8)
            {
              this.out[m] = ((byte)(arrayOfByte3[(0 + this.preCrypt + this.pos)] ^ this.prePlain[this.pos]));
              m++;
              n--;
              this.pos = (1 + this.pos);
            }
          ...
          if (this.pos < 8)
          {
            if ((arrayOfByte4[(0 + this.preCrypt + this.pos)] ^ this.prePlain[this.pos]) != 0)
              return null;
            this.pos = (1 + this.pos);
          }
          if (this.pos == 8)
        ...
        label422: arrayOfByte3 = paramArrayOfByte1;
      }
      label428: arrayOfByte2 = paramArrayOfByte1;
    }
  }
