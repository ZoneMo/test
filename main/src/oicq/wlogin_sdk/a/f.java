...
public final class f
{
  ...
  // ERROR //
  private static TreeMap as(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    //   2: aload_0
    //   3: aload_1
    //   4: invokestatic 117	oicq/wlogin_sdk/a/f:at	(Landroid/content/Context;Ljava/lang/String;)[B
    //   7: astore_3
    //   8: aload_3
    //   9: ifnull +572 -> 581
    //   12: new 119	javax/crypto/spec/SecretKeySpec
    //   15: dup
    //   16: getstatic 125	oicq/wlogin_sdk/a/k:hxR	[B
    //   19: ldc 127
    ...
    //   137: invokestatic 183	oicq/wlogin_sdk/c/f:bn	(Ljava/lang/String;Ljava/lang/String;)V
    //   140: aload_0
    //   141: invokestatic 187	oicq/wlogin_sdk/c/f:cl	(Landroid/content/Context;)[B
    //   144: astore 30
    //   146: aload 30
    //   148: ifnull +91 -> 239
    //   151: aload 30
    ...
    //   238: astore_2
    //   239: aload_0
    //   240: invokestatic 190	oicq/wlogin_sdk/c/f:ck	(Landroid/content/Context;)[B
    //   243: astore 25
    //   245: aload 25
    //   247: ifnull +94 -> 341
    //   250: aload 25
    ...
    //   259: dup
    //   260: aload 25
    //   262: invokestatic 196	oicq/wlogin_sdk/c/d:cK	([B)[B
    //   265: ldc 127
    ...
    //   340: astore_2
    //   341: aload_0
    //   342: invokestatic 199	oicq/wlogin_sdk/c/f:cj	(Landroid/content/Context;)[B
    //   345: astore 20
    //   347: aload 20
    //   349: ifnull +94 -> 443
    //   352: aload 20
    ...
    //   361: dup
    //   362: aload 20
    //   364: invokestatic 196	oicq/wlogin_sdk/c/d:cK	([B)[B
    //   367: ldc 127
  ...
  // ERROR //
  private static byte[] at(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: iconst_0
  ...
  private int b(TreeMap paramTreeMap, String paramString)
  {
    try
    {
      SecretKeySpec localSecretKeySpec = new SecretKeySpec(k.hxR, "DESede");
      ...
      int j = a(this.hxo, paramString, localByteArrayOutputStream.toByteArray());
      i = j;
      return i;
    }
    catch (Exception localException)
    {
      while (true)
      {
        ...
        oicq.wlogin_sdk.c.f.bn("exception", localStringWriter.toString());
        int i = -1022;
      }
    }
    finally
  ...
  private c cr(long paramLong)
  {
    try
    {
      oicq.wlogin_sdk.c.f.bm("get_all_siginfo", "uin=" + paramLong);
      Object localObject2 = (c)this.hxp.get(new Long(paramLong));
      ...
      while (true)
      {
        ...
        {
          TreeMap localTreeMap = as(this.hxo, "tk_file");
          ...
          else
          {
            ...
            if (localc1 == null)
            {
              oicq.wlogin_sdk.c.f.bm("get_all_siginfo", "null");
              localObject2 = null;
            }
            else
            {
              this.hxp.put(new Long(paramLong), localc1);
              c localc2 = localc1.aQp();
  ...
  public final int a(long paramLong1, long paramLong2, long paramLong3, long paramLong4, long paramLong5, long paramLong6, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, byte[] paramArrayOfByte6, byte[] paramArrayOfByte7, byte[] paramArrayOfByte8, byte[] paramArrayOfByte9, byte[] paramArrayOfByte10, byte[] paramArrayOfByte11, byte[] paramArrayOfByte12, byte[] paramArrayOfByte13, byte[] paramArrayOfByte14, byte[] paramArrayOfByte15, byte[] paramArrayOfByte16, byte[][] paramArrayOfByte)
  {
    while (true)
    {
      ...
      try
      {
        localc1 = (c)this.hxp.get(new Long(paramLong1));
        if (localc1 != null)
          break label334;
        localc2 = new c();
        arrayOfByte1 = new byte[0];
        WloginSigInfo localWloginSigInfo1 = (WloginSigInfo)localc2.hwY.get(new Long(paramLong2));
        if ((localWloginSigInfo1 != null) && (localWloginSigInfo1.hyo != null))
        {
          arrayOfByte2 = (byte[])localWloginSigInfo1.hyo.clone();
          ...
          localc2.hwX = localWloginSimpleInfo;
          int i = localc2.a(paramLong2, paramLong3, paramLong4, paramLong5, paramLong6, paramArrayOfByte5, paramArrayOfByte6, paramArrayOfByte7, paramArrayOfByte8, paramArrayOfByte9, paramArrayOfByte10, paramArrayOfByte11, paramArrayOfByte12, paramArrayOfByte13, paramArrayOfByte14, paramArrayOfByte15, paramArrayOfByte16, paramArrayOfByte);
          oicq.wlogin_sdk.c.f.yh("before put_siginfo, ret=0");
          if (this.hxo != null)
          {
            TreeMap localTreeMap = as(this.hxo, "tk_file");
            if (localTreeMap == null)
              localTreeMap = new TreeMap();
            oicq.wlogin_sdk.c.f.yh("after loadTKTreeMap");
            localTreeMap.put(new Long(paramLong1), localc2.aQp());
            i = a(localTreeMap, "tk_file");
            oicq.wlogin_sdk.c.f.yh("after refreshTKTreeMap, ret=" + i);
          }
          int j = i;
          if (j != 0)
          {
            WloginSigInfo localWloginSigInfo2 = (WloginSigInfo)localc2.hwY.get(new Long(paramLong2));
            if (localWloginSigInfo2 != null)
              localWloginSigInfo2.hyo = ((byte[])arrayOfByte2.clone());
          }
          this.hxp.put(new Long(paramLong1), localc2);
          return j;
        }
      }
      finally
  ...
  public final int a(long paramLong1, long paramLong2, long paramLong3, long paramLong4, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    try
    {
      c localc = (c)this.hxp.get(new Long(paramLong1));
      if (localc == null);
      for (int i = -1; ; i = 0)
      {
        return i;
        localc.a(paramLong2, paramLong3, paramLong4, paramArrayOfByte1, paramArrayOfByte2);
        if (this.hxo != null)
        {
          TreeMap localTreeMap = as(this.hxo, "tk_file");
          if (localTreeMap == null)
            localTreeMap = new TreeMap();
          localTreeMap.put(new Long(paramLong1), localc.aQp());
  ...
  public final void c(Long paramLong)
  {
    try
    {
      this.hxp.remove(paramLong);
      TreeMap localTreeMap;
      if (this.hxo != null)
      {
        localTreeMap = as(this.hxo, "tk_file");
        if (localTreeMap != null)
          break label37;
      }
      while (true)
  ...
  public final WloginSigInfo cs(long paramLong)
  {
    try
    {
      ...
      while (true)
      {
        ...
        localWloginSigInfo = (WloginSigInfo)localc.hwY.get(new Long(522017402L));
