...
{
  private static final Class[] ii = arrayOfClass;
  private static final Class[] ij = arrayOfClass;
  ...
  public c(Context paramContext)
  {
    ...
    this.im = paramContext;
    this.ik = new Object[] { paramContext };
    this.il = this.ik;
  }
  ...
  private void a(XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Menu paramMenu)
  {
    ...
    case 3:
      while (true)
      {
        ...
        {
          a(paramXmlPullParser, paramAttributeSet, locale.bz());
          n = j;
        }
        else
        {
