...
public final class as extends ap
{
  ...
  private as(Object paramObject)
  {
    this.MC = paramObject;
  }

  public static an O(Object paramObject)
  {
    return new as(paramObject);
  }

  public static Object a(an paraman)
  {
    if ((paraman instanceof as))
      return ((as)paraman).MC;
    IBinder localIBinder = paraman.asBinder();
