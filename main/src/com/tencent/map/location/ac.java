...
public final class ac
{
  ...
  public static String a(m paramm, List paramList)
  {
    ...
    int i = paramm.b;
    int j = paramm.Uc;
    boolean bool = a(paramm.a, i, j, paramm.Ud, paramm.Um);
    int k = 0;
    if (bool)
    {
      localStringBuilder.append(a(i, j, paramm.Ud, paramm.Um, paramm.Un, paramm.g, paramm.Uo));
      k = 1;
    }
    if (paramList != null);
    while (true)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if (!a(paramm.a, i, j, m, localNeighboringCellInfo.getCid()))
            break label270;
          if (k > 0)
            localStringBuilder.append(",");
  ...
  public static String b(q paramq)
  {
    if (paramq.ma() == null)
      return "{}";
    Location localLocation = paramq.ma();
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("{");
  ...
  {
    if ((paramz == null) || (paramz.lY() == null))
      return "[]";
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("[");
    if ((paramz.lY() == null) || (paramz.lY().size() <= 0))
    {
      localStringBuilder.append("]");
      return localStringBuilder.toString();
    }
    List localList = paramz.lY();
