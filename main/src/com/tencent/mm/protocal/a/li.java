...
public final class li extends com.tencent.mm.am.a
{
  public int fAC;
  public LinkedList fAD = new LinkedList();

  public static boolean a(a.a.a.a.a parama, li paramli, int paramInt)
  {
    switch (paramInt)
    {
    default:
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      for (boolean bool = true; bool; bool = lh.a(locala, locallh, a(locala)));
      paramli.fAD.add(locallh);
    }
    return true;
  }
