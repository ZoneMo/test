...
{
  private static RegionCodeDecoder gja = null;
  public static final String gjb = "/data/data/" + al.getContext().getPackageName() + "/MicroMsg/regioncode/";
  private String gjc = "";
  private String gjd = "";

  public static RegionCodeDecoder aDe()
  {
    if (gja == null)
      gja = new RegionCodeDecoder();
    RegionCodeDecoder localRegionCodeDecoder = gja;
    if (!z.azj().equals(localRegionCodeDecoder.gjc))
      localRegionCodeDecoder.aAf();
    return gja;
  }
  ...
  private static void aDf()
  {
    ...
    //   4: newarray byte
    //   6: astore_1
    //   7: invokestatic 28	com/tencent/mm/sdk/platformtools/al:getContext	()Landroid/content/Context;
    ...
    //   164: dup
    //   165: aload 22
    //   167: invokestatic 109	com/tencent/mm/storage/RegionCodeDecoder:vv	(Ljava/lang/String;)Ljava/lang/String;
  ...
  private String aDg()
  {
    ...
    if (this.gjc.equalsIgnoreCase("zh_HK"));
    String str2;
    File localFile;
    for (String str1 = "zh_TW"; ; str1 = this.gjc)
    {
      str2 = str1 + ".txt";
      localFile = new File(gjb);
      if (localFile.exists())
        break;
      localFile.mkdir();
      return null;
  ...
  {
    boolean bool1 = cj.hX(paramString1);
    String str = null;
    if (!bool1)
    {
      boolean bool2 = cj.hX(paramString2);
      str = null;
      if (!bool2)
        break label38;
    }
    ...
    {
      if (cj.hX(str))
        str = cj.hW(paramString2);
      return str;
      label38: str = getLocName(w(paramString1, paramString2, null));
    }
  }
  ...
  public static String vy(String paramString)
  {
    ...
    if (cj.hX(str))
      str = cj.hW(paramString);
    return str;
  }

  public static final String w(String paramString1, String paramString2, String paramString3)
  {
  ...
  public static String x(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (String str = null; ; str = getLocName(w(paramString1, paramString2, paramString3)))
    {
      if (cj.hX(str))
        str = cj.hW(paramString3);
      return str;
    }
  }
  ...
  public final void aAf()
  {
    ...
    String str1 = aDg();
    if (cj.hX(str1))
      aa.e("MicroMsg.RegionCodeDecoder", "buildMap error, no codeFile found, curLang: " + this.gjc);
    String str2;
    do
    {
      return;
    ...
    while (str2.equals(this.gjd));
    this.gjd = str2;
    RegionCodeDecoder.DecoderJni.buildFromFile(this.gjd);
  }

  public final RegionCodeDecoder.Region[] aDh()
  {
    if (cj.hX(this.gjd))
      return null;
    return RegionCodeDecoder.DecoderJni.getCountries(this.gjd);
  }

  public final RegionCodeDecoder.Region[] aX(String paramString1, String paramString2)
  {
    if ((cj.hX(this.gjd)) || (cj.hX(paramString1)) || (cj.hX(paramString2)))
      return null;
    return RegionCodeDecoder.DecoderJni.getCities(this.gjd, paramString1, paramString2);
  }

  public final RegionCodeDecoder.Region[] vz(String paramString)
  {
    if ((cj.hX(this.gjd)) || (cj.hX(paramString)))
      return null;
    return RegionCodeDecoder.DecoderJni.getProvinces(this.gjd, paramString);
  }
}
