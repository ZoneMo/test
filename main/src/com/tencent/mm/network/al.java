  ...
  implements ak
{
  ...
  public static ak k(IBinder paramIBinder)
  {
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 5:
      paramParcel1.enforceInterface("com.tencent.mm.network.IReqResp_AIDL");
      a(p.f(paramParcel1.readStrongBinder()), z.i(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt());
      paramParcel2.writeNoException();
      return true;
    case 6:
      paramParcel1.enforceInterface("com.tencent.mm.network.IReqResp_AIDL");
    ...
    case 8:
      paramParcel1.enforceInterface("com.tencent.mm.network.IReqResp_AIDL");
      ey(paramParcel1.readString());
      paramParcel2.writeNoException();
      return true;
    case 9:
      paramParcel1.enforceInterface("com.tencent.mm.network.IReqResp_AIDL");
      a(p.f(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt());
      paramParcel2.writeNoException();
      return true;
    case 10:
    }
    paramParcel1.enforceInterface("com.tencent.mm.network.IReqResp_AIDL");
    b(p.f(paramParcel1.readStrongBinder()), z.i(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt());
    paramParcel2.writeNoException();
    return true;
  }
}
