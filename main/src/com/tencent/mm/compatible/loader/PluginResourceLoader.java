...
public class PluginResourceLoader extends Resources
{
  ...
  public PluginResourceLoader(Resources paramResources)
  {
    ...
    try
    {
      ...
      {
        str1 = s.ceN.cey;
        aa.e("MicroMsg.PluginResourceLoader", "loadDrawable %s ", new Object[] { str1 });
      }
      if (!cj.hX(s.ceN.cez))
      {
        str2 = s.ceN.cez;
        aa.e("MicroMsg.PluginResourceLoader", "loadXmlResourceParser %s ", new Object[] { str2 });
      }
      Class[] arrayOfClass1 = new Class[2];
      arrayOfClass1[0] = TypedValue.class;
      arrayOfClass1[1] = Integer.TYPE;
      this.cfn = Resources.class.getDeclaredMethod(str1, arrayOfClass1);
      this.cfn.setAccessible(true);
      ...
      this.cfo = Resources.class.getDeclaredMethod(str2, arrayOfClass2);
  ...
  private XmlResourceParser a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    try
    {
      Method localMethod = this.cfo;
      Resources localResources = this.cfm;
  ...
  private Drawable a(TypedValue paramTypedValue, int paramInt)
  {
    ...
    {
      aa.e("MicroMsg.PluginResourceLoader", "load drawable StackOverflowError");
      try
      {
      ...
      {
        Iterator localIterator = this.bd.entrySet().iterator();
        ...
        aa.d("MicroMsg.PluginResourceLoader", "loadFromZipFile null");
        return null;
      }
    }
  ...
  private Drawable a(ZipFile paramZipFile, TypedValue paramTypedValue)
  {
    ...
    //   1: astore_3
    //   2: aload_2
    //   3: getfield 139	android/util/TypedValue:string	Ljava/lang/CharSequence;
    //   6: ifnonnull +9 -> 15
    //   9: aconst_null
    //   10: astore 7
    //   12: aload 7
    //   14: areturn
    //   15: aload_2
    //   16: getfield 154	android/util/TypedValue:assetCookie	I
    //   19: i2l
    //   20: bipush 32
    //   22: lshl
    //   23: aload_2
    ...
    //   29: lstore 4
    //   31: aload_0
    //   32: getfield 46	com/tencent/mm/compatible/loader/PluginResourceLoader:cfp	Lcom/tencent/mm/compatible/loader/c;
    //   35: lload 4
    ...
    //   78: ldc 70
    //   80: ldc 219
    //   82: invokestatic 222	com/tencent/mm/sdk/platformtools/aa:v	(Ljava/lang/String;Ljava/lang/String;)V
    //   85: aload 7
    //   87: areturn
    //   88: aload_0
    //   89: getfield 46	com/tencent/mm/compatible/loader/PluginResourceLoader:cfp	Lcom/tencent/mm/compatible/loader/c;
    //   92: lload 4
    ...
    //   100: goto -27 -> 73
    //   103: aload_2
    //   104: getfield 139	android/util/TypedValue:string	Ljava/lang/CharSequence;
    ...
    //   136: ldc 231
    //   138: aload 10
    //   140: invokestatic 234	com/tencent/mm/sdk/platformtools/aa:f	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   143: aload_1
    //   144: aload 8
    //   146: invokevirtual 238	java/util/zip/ZipFile:getEntry	(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    //   149: astore 11
    //   151: aload_1
    //   152: aload 11
    //   154: invokevirtual 242	java/util/zip/ZipFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   157: astore 19
    //   159: aload 19
    //   161: astore_3
    //   162: aload_0
    ...
    //   164: aload_3
    //   165: aload 8
    //   167: invokestatic 246	android/graphics/drawable/Drawable:createFromResourceStream	(Landroid/content/res/Resources;Landroid/util/TypedValue;Ljava/io/InputStream;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    //   170: astore 21
    //   172: aload 21
    //   174: astore 7
    //   176: aload_3
    //   177: ifnull +7 -> 184
    //   180: aload_3
    //   181: invokevirtual 249	java/io/InputStream:close	()V
    //   184: aload 7
    //   186: ifnonnull +20 -> 206
    //   189: aload_1
    //   190: aload 11
    //   192: invokevirtual 242	java/util/zip/ZipFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   195: aload 8
    //   197: invokestatic 253	android/graphics/drawable/Drawable:createFromStream	(Ljava/io/InputStream;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    //   200: astore 18
    //   202: aload 18
    //   204: astore 7
    //   206: aload 7
    //   208: ifnull -196 -> 12
    //   211: aload_0
    //   212: getfield 46	com/tencent/mm/compatible/loader/PluginResourceLoader:cfp	Lcom/tencent/mm/compatible/loader/c;
    //   215: lload 4
    //   217: new 209	java/lang/ref/WeakReference
    //   220: dup
    //   221: aload 7
    //   223: invokevirtual 257	android/graphics/drawable/Drawable:getConstantState	()Landroid/graphics/drawable/Drawable$ConstantState;
    //   226: invokespecial 260	java/lang/ref/WeakReference:<init>	(Ljava/lang/Object;)V
    //   229: invokevirtual 264	com/tencent/mm/compatible/loader/c:put	(JLjava/lang/Object;)V
    //   232: aload 7
    //   234: areturn
    //   235: astore 16
    //   237: aload_3
    //   238: ifnull -54 -> 184
    //   241: aload_3
    //   242: invokevirtual 249	java/io/InputStream:close	()V
    //   245: goto -61 -> 184
    //   248: astore 17
    //   250: goto -66 -> 184
    //   253: astore 12
    ...
    //   264: ifnull +8 -> 272
    //   267: aload 13
    //   269: invokevirtual 249	java/io/InputStream:close	()V
    //   272: aload 14
    //   274: athrow
    //   275: astore 9
    //   277: goto -71 -> 206
  ...
  private static InputStream b(ZipFile paramZipFile, TypedValue paramTypedValue)
  {
    ...
    try
    {
      ...
      aa.e("MicroMsg.PluginResourceLoader", "try load stream from zip, entry=%s, file=%s", arrayOfObject);
