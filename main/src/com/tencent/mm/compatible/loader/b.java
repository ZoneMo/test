...
{
  private static final Map ceV = new HashMap();
  private String ceR;
  private Context ceS;
  private ClassLoader ceT;
  private AssetManager ceU;
  ...
  private b(Context paramContext, String paramString1, String paramString2)
  {
    ...
    //   23: aload_0
    //   24: aload_2
    //   25: putfield 42	com/tencent/mm/compatible/loader/b:ceR	Ljava/lang/String;
    //   28: aload_0
    //   29: aload_3
    //   30: putfield 44	com/tencent/mm/compatible/loader/b:pkgName	Ljava/lang/String;
    //   33: aload_0
    //   34: aload_1
    //   35: putfield 46	com/tencent/mm/compatible/loader/b:ceS	Landroid/content/Context;
    //   38: aload_0
    ...
    //   62: putfield 71	com/tencent/mm/compatible/loader/b:ceT	Ljava/lang/ClassLoader;
    //   65: aload_0
    //   66: ldc 73
    //   68: invokevirtual 79	java/lang/Class:newInstance	()Ljava/lang/Object;
    //   71: checkcast 73	android/content/res/AssetManager
    //   74: putfield 81	com/tencent/mm/compatible/loader/b:ceU	Landroid/content/res/AssetManager;
    //   77: ldc 73
    //   79: ldc 83
    //   81: iconst_1
    ...
    //   93: astore 9
    //   95: aload_0
    //   96: getfield 81	com/tencent/mm/compatible/loader/b:ceU	Landroid/content/res/AssetManager;
    //   99: astore 10
    //   101: iconst_1
    ...
    //   109: iconst_0
    //   110: aload_0
    //   111: getfield 42	com/tencent/mm/compatible/loader/b:ceR	Ljava/lang/String;
    //   114: aastore
    //   115: aload 9
    //   117: aload 10
    //   119: aload 11
    ...
    //   124: pop
    //   125: aload_0
    //   126: getfield 46	com/tencent/mm/compatible/loader/b:ceS	Landroid/content/Context;
    ...
    //   135: astore 7
    //   137: aload_0
    //   138: getfield 46	com/tencent/mm/compatible/loader/b:ceS	Landroid/content/Context;
    ...
    //   153: dup
    //   154: aload_0
    //   155: getfield 81	com/tencent/mm/compatible/loader/b:ceU	Landroid/content/res/AssetManager;
    //   158: aload 7
    //   160: aload 8
    ...
    //   165: putfield 116	com/tencent/mm/compatible/loader/b:kr	Landroid/content/res/Resources;
    //   168: ldc 118
    //   170: ldc 120
    //   172: iconst_1
    ...
    //   178: aload_3
    //   179: aastore
    //   180: invokestatic 126	com/tencent/mm/sdk/platformtools/aa:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   183: return
    //   184: iconst_0
    //   185: istore 4
    //   187: goto -171 -> 16
    ...
    //   199: invokestatic 132	com/tencent/mm/sdk/platformtools/aa:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   202: return
    //   203: astore 6
    //   205: goto -80 -> 125
    //
  ...
  public static b a(Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    try
    {
      b localb = (b)ceV.get(paramString1);
      if (localb == null)
      {
        Map localMap = ceV;
  ...
  public final Drawable getDrawable(String paramString)
  {
    ...
    do
    {
      ...
      {
        return null;
        aa.e("MicroMsg.ExternalResContext", "packname:%s", new Object[] { paramString });
        if (this.kr != null)
        {
          int j = this.kr.getIdentifier(paramString, "drawable", this.pkgName);
          if (j > 0)
            return this.kr.getDrawable(j);
        }
      }
      while (this.ceS == null);
      i = this.ceS.getResources().getIdentifier(paramString, "drawable", this.ceS.getPackageName());
    }
    while (i <= 0);
    return this.ceS.getResources().getDrawable(i);
  }
  ...
  public final String getString(String paramString1, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        if (this.kr != null)
        {
          int j = this.kr.getIdentifier(paramString1, "string", this.pkgName);
          if (j > 0)
            return this.kr.getString(j);
        }
      }
      while (this.ceS == null);
      i = this.ceS.getResources().getIdentifier(paramString1, "string", this.ceS.getPackageName());
    }
    while (i <= 0);
    return this.ceS.getString(i);
  }
}
