...
{
  @TargetApi(5)
  public static b h(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      ...
      aa.d("MicroMsg.GetVideoMetadata", "dataString " + str1);
    }
    while (str1 == null);
          ...
          try
          {
            ...
            if (str1.startsWith("content://"))
            {
              ...
              if (!localb.filename.startsWith("/storage/emulated/legacy"))
                break label461;
              localb.filename = (l.getExternalStorageDirectory().getAbsolutePath() + localb.filename.substring(24));
            }
            while (true)
            {
              ...
              if (paramIntent.getExtras() != null)
              {
                ...
                if ((localUri != null) && (!cj.hX(localUri.getPath())))
              ...
              label461: if (localb.filename.startsWith("/sdcard"))
                localb.filename = (l.getExternalStorageDirectory().getAbsolutePath() + localb.filename.substring(7));
            }
          }
