...
public final class b
{
  ...
  public static String avt()
  {
    ...
    //   62: ifnull +48 -> 110
    //   65: aload 10
    //   67: invokestatic 51	com/tencent/mm/sdk/platformtools/cj:hX	(Ljava/lang/String;)Z
    //   70: ifne -17 -> 53
    ...
    //   98: invokestatic 69	com/tencent/mm/al/b:rq	(Ljava/lang/String;)Ljava/lang/String;
    //   101: astore 11
    //   103: aload 11
    //   105: astore 5
    //   107: goto -54 -> 53
  ...
  public static String avv()
  {
    ...
    {
      new DisplayMetrics();
      DisplayMetrics localDisplayMetrics = al.getContext().getResources().getDisplayMetrics();
  ...
  public static String avx()
  {
    ...
    try
    {
      StatFs localStatFs = new StatFs(l.getExternalStorageDirectory().getPath());
      long l = localStatFs.getBlockSize();
      str1 = str1 + "AvailableSizes:" + l * localStatFs.getAvailableBlocks() + ";";
      str1 = str1 + "FreeSizes:" + l * localStatFs.getFreeBlocks() + ";";
      String str2 = str1 + "AllSize:" + l * localStatFs.getBlockCount() + ";";
  ...
  {
    return (String)be.uz().sr().get(71, null);
  }
