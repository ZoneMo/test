...
final class dt extends ce
{
  ...
  public final View a(LayoutInflater paramLayoutInflater, View paramView)
  {
    ...
    {
      paramView = new cz(paramLayoutInflater, 2130903191);
      paramView.setTag(new ly(this.dws).c(paramView, false));
    }
    return paramView;
  }
  ...
  public final void a(cf paramcf, int paramInt, ChattingUI paramChattingUI, ak paramak)
  {
    ...
    ly.a((ly)paramcf, paramak, false, paramInt, paramChattingUI);
  }
