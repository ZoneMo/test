...
final class bp extends ListView
{
  private boolean oL;
  private boolean oM;

  public bp(Context paramContext, boolean paramBoolean)
  {
  ...
  {
    return (this.oM) || (super.hasFocus());
  }

  public final boolean hasWindowFocus()
  {
    return (this.oM) || (super.hasWindowFocus());
  }

  public final boolean isFocused()
  {
    return (this.oM) || (super.isFocused());
  }

  public final boolean isInTouchMode()
  {
    return ((this.oM) && (this.oL)) || (super.isInTouchMode());
  }
}
