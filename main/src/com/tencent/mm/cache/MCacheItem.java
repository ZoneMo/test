  ...
  implements Parcelable
{
  ...
  // ERROR //
  private ad n(Parcel paramParcel)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore_2
    ...
    //   17: checkcast 48	com/tencent/mm/sdk/e/ad
    //   20: putfield 27	com/tencent/mm/cache/MCacheItem:caV	Lcom/tencent/mm/sdk/e/ad;
    //   23: aload 4
    //   25: invokestatic 52	com/tencent/mm/sdk/e/ad:d	(Ljava/lang/Class;)[Ljava/lang/reflect/Field;
    //   28: astore 6
    //   30: aload 6
    //   32: arraylength
    //   33: istore 7
    ...
    //   44: aaload
    //   45: astore 8
    //   47: getstatic 58	com/tencent/mm/cache/f:caX	Ljava/util/Map;
    //   50: aload 8
    ...
    //   89: iconst_2
    //   90: aload_0
    //   91: getfield 27	com/tencent/mm/cache/MCacheItem:caV	Lcom/tencent/mm/sdk/e/ad;
    //   94: aastore
    //   95: aload 9
    //   97: aconst_null
    //   98: aload 11
    ...
    //   107: goto -72 -> 35
    //   110: aload_0
    //   111: getfield 27	com/tencent/mm/cache/MCacheItem:caV	Lcom/tencent/mm/sdk/e/ad;
    //   114: astore 13
    //   116: aload 13
    //   118: areturn
    //   119: astore_3
  ...
  {
    paramParcel.writeString(this.caV.getClass().getName());
    Field[] arrayOfField = ad.d(this.caV.getClass());
    ...
    while (true)
    {
      ...
      if (j < i)
      {
        ...
        localMethod = (Method)f.caW.get(localField.getType());
        if (localMethod == null);
      }
      try
      {
