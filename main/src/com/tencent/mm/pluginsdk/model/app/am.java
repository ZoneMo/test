  ...
  implements ao
{
  ...
  public final void N(int paramInt1, int paramInt2)
  {
    ...
    aa.e("MicroMsg.NetSceneSendAppMsg", "cdntra NetSceneSendAppMsgForCdn callback %d,%d", arrayOfObject1);
    ...
    arrayOfObject2[2] = Long.valueOf(ak.c(this.fhK.fhJ));
    ...
    ak.d(this.fhK.fhJ).a(paramInt1, paramInt2, "", this.fhK.fhJ);
  }
}
