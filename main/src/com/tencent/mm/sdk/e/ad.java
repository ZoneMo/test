...
public abstract class ad
{
  ...
  private static Map b(Field[] paramArrayOfField)
  {
    ...
    if (i < paramArrayOfField.length)
    {
      ...
      String str1 = a.c(localField.getType());
      if (str1 == null)
        aa.e("MicroMsg.SDK.IAutoDBItem", "failed identify on column: " + localField.getName() + ", skipped");
      while (true)
      {
        i++;
        break;
  ...
  private static String c(Field[] paramArrayOfField)
  {
    ...
    if (i < paramArrayOfField.length)
    {
      ...
      if (!localField.isAnnotationPresent(ag.class))
        break label239;
      str3 = " default '" + ((ag)localField.getAnnotation(ag.class)).azX() + "' ";
    }
    for (int j = ((ag)localField.getAnnotation(ag.class)).azY(); ; j = 0)
    {
  ...
  public static Field[] d(Class paramClass)
  {
    ae localae = new ae();
    ...
    if (j < i)
    {
      ...
      if ((str1 != null) && (Modifier.isPublic(k)) && (!Modifier.isFinal(k)))
      {
        ...
        label95: if (!localField.isAnnotationPresent(ag.class))
          break label176;
        if (((ag)localField.getAnnotation(ag.class)).azY() == 1)
          localae.gfz = str2;
      }
      while (true)
      {
    ...
    localae.cAj = ((Field[])localLinkedList.toArray(new Field[0]));
    localae.bZx = a(localae.cAj);
    localae.gfA = b(localae.cAj);
    localae.cjp = c(localae.cAj);
    return localae.cAj;
  }

  public abstract void convertFrom(Cursor paramCursor);

  public abstract ContentValues oa();

  protected abstract ae qE();
}

/* Location:           /Users/don/Desktop/mm/com.tencent.mm/classes-dex2jar.jar
 * Qualified Name:     com.tencent.mm.sdk.e.ad
