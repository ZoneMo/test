...
public final class m
{
  ...
  public static boolean o(Context paramContext, String paramString1, String paramString2)
  {
    ...
    {
      aa.e("MicroMsg.SDK.FilesCopy", "copy assets file srcpath=%s to=%s failed, try pattern now", new Object[] { paramString1, paramString2 });
      while (true)
      {
        ...
        try
        {
          ...
          {
            aa.e("MicroMsg.SDK.FilesCopy", "copy pattern %s", new Object[] { str });
            i++;
          }
        }
