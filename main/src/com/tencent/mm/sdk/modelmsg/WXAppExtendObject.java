  ...
  implements p
{
  ...
  public boolean checkArgs()
  {
    ...
    {
      aa.e("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, all arguments is null");
      return false;
    }
    if ((this.extInfo != null) && (this.extInfo.length() > 2048))
    {
      aa.e("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, extInfo is invalid");
      return false;
    }
    if ((this.filePath != null) && (this.filePath.length() > 10240))
    {
      aa.e("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, filePath is invalid");
      return false;
    }
    if ((this.filePath != null) && (getFileSize(this.filePath) > 10485760))
    {
      aa.e("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, fileSize is too large");
      return false;
    }
    if ((this.fileData != null) && (this.fileData.length > 10485760))
    {
      aa.e("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, fileData is too large");
      return false;
    }
    return true;
  }
