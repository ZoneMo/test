  ...
  implements p
{
  ...
  public boolean checkArgs()
  {
    ...
    {
      aa.e("MicroMsg.SDK.WXFileObject", "checkArgs fail, both arguments is null");
      return false;
    }
    if ((this.fileData != null) && (this.fileData.length > this.contentLengthLimit))
    {
      aa.e("MicroMsg.SDK.WXFileObject", "checkArgs fail, fileData is too large");
      return false;
    }
    if ((this.filePath != null) && (getFileSize(this.filePath) > this.contentLengthLimit))
    {
      aa.e("MicroMsg.SDK.WXFileObject", "checkArgs fail, fileSize is too large");
      return false;
    }
    return true;
  }
